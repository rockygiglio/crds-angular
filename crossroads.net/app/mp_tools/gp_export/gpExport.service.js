...
(function() {
  ...
  function GPExport($resource) {
    return {
      FileNames: $resource(__GATEWAY_CLIENT_ENDPOINT__ + 'api/gpexport/filenames/:selectionId'),

      // Found this here http://davidjs.com/2015/07/download-files-via-post-request-in-angularjs/
      File: $resource(__GATEWAY_CLIENT_ENDPOINT__ + 'api/gpexport/file/:selectionId/:depositId', 
