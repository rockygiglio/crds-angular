...
export default class AddRoomController {
    ...
    $onInit() {
        ...
        if (this.addEvent.editMode) {
            Lookup.query({ table: 'crossroadslocations' }, (locations) => {
            ...
            this.room.ByCongregation.query({
                ...
                this.room.Equipment.query({ congregationId: this.addEvent.eventData.event.congregation.dp_RecordID },
                    (data) => {
                        ...
                        var self = this;
                        _.forEach(this.selectedRooms, function (roomD) {
    ...
    onAdd() {
        if (this.chosenRoom) {
            ...
            var alreadyAdded = _.find(this.selectedRooms, function (r) {
            ...
            this.selectedRooms.push(this.chosenRoom);
            return;
        }
    ...
    removeRoom(currentRoom) {
        ...
        modalInstance.result.then(function () {
            if (!_.has(currentRoom, 'cancelled')) {
                this.selectedRooms = _.filter(this.selectedRooms, function (r) {
