(function() {
  ...
  function TripsSignupService($resource, $location, $log, $stateParams) {
    var signupService = {
      ...
      pages: [],
      reset: reset,
      TripApplication: $resource(__GATEWAY_CLIENT_ENDPOINT__ + 'api/trip-application'),
      CreateTripParticipant: $resource(__GATEWAY_CLIENT_ENDPOINT__+ 'api/trip-participant'),
      CampaignInfo: $resource(__GATEWAY_CLIENT_ENDPOINT__ + 'api/trip-application/:contactId/:campaignId'),
      donorId: null,
      programId: null,
      programName: null,
      pledgeAmount: null,
