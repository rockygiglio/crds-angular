...
/****** Object:  StoredProcedure [dbo].[report_CRDS_Trip_Export]    Script Date: 11/30/2016 11:16:04 AM ******/
SET ANSI_NULLS ON
GO
...
SELECT 	c.first_name,
	...
	case
       when p.Approved_Small_Group_Leader = 1 then 'Yes'
       when p.Approved_Small_Group_Leader = 0 then 'No'
       else 'Unknown'
