...
IF NOT EXISTS(SELECT * FROM [dbo].dp_Communications WHERE communication_id = 2009)
	BEGIN
	...
	(2009            ,5             ,'Welcome to the gathering','temp',1        ,{ts '2017-03-10 00:00:00'},1                      ,768371     ,768371           ,1       ,1     )
