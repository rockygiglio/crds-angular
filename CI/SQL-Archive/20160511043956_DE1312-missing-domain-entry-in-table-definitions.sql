...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Destinations]') AND parent_object_id = OBJECT_ID(N'[dbo].[cr_Destinations]'))
Begin
...
BEGIN
	...
	ADD Domain_ID [int] NOT NULL DEFAULT(1)
END
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Onboarding_Statuses]') AND parent_object_id = OBJECT_ID(N'[dbo].[cr_Onboarding_Statuses]'))
...
BEGIN
	...
	ADD Domain_ID [int] NOT NULL DEFAULT(1)
END
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Other_Organizations]') AND parent_object_id = OBJECT_ID(N'[dbo].[cr_Other_Organizations]'))
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Reminder_Days_Prior_Domain]') AND parent_object_id = OBJECT_ID(N'[dbo].[cr_Reminder_Days_Prior]'))
ALTER TABLE [dbo].[cr_Reminder_Days_Prior]  WITH CHECK ADD  CONSTRAINT [FK_Reminder_Days_Prior_Domain] FOREIGN KEY([Domain_ID])
REFERENCES [dbo].[dp_Domains] ([Domain_ID])
GO
...
BEGIN
	...
	ADD Domain_ID [int] NOT NULL DEFAULT(1)
END
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Sign_Up_Deadline]') AND parent_object_id = OBJECT_ID(N'[dbo].[cr_Sign_Up_Deadline]'))
...
BEGIN
	...
	ADD Domain_ID [int] NOT NULL DEFAULT(1)
END
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Serve_Restrictions_Reasons_Domain]') AND parent_object_id = OBJECT_ID(N'[dbo].[cr_Serve_Restrictions_Reasons]'))
...
BEGIN
	...
	ADD Domain_ID [int] NOT NULL DEFAULT(1)
END
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Work_Teams]') AND parent_object_id = OBJECT_ID(N'[dbo].[cr_Work_Teams]'))
