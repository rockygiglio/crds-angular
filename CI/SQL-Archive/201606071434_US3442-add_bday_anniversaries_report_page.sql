...
IF NOT EXISTS(SELECT * FROM [dbo].[dp_reports] WHERE Report_Path = '/MPReports/CRDS Group BirthDay Anniversaries')
BEGIN
	INSERT INTO [dbo].[dp_reports]
		 ...
		 VALUES
			   (N'Group Birthday & Anniversaries'
			   ,N'Group Birthday & Anniversaries'
			   ,N'/MPReports/CRDS Group BirthDay Anniversaries'
			   ,1
			   ,0          
			   ,1)
END
