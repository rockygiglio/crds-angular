...
DECLARE @PAGE_ID int = 613 -- Assigned by MPIdentityMaintenance.dbo.Get_Next_Available_ID
DECLARE @PAGE_SECTION_ID int = 11 -- "System Lookups" page
DECLARE @DISPLAY_NAME nvarchar(50) = N'Kiosk Types'
DECLARE @SINGULAR_NAME nvarchar(50) = N'Kiosk Type'
DECLARE @DESCRIPTION nvarchar(255) = N'Types used for determining Kiosk Config type.'
DECLARE @VIEW_ORDER smallint = 275
DECLARE @TABLE_NAME nvarchar(50) = 'cr_Kiosk_Types'
DECLARE @PRIMARY_KEY nvarchar(50) = 'Kiosk_Type_ID'
DECLARE @DEFAULT_FIELD_LIST nvarchar(2000) = 'Kiosk_Type_ID,
Kiosk_Type,
Description'
DECLARE @SELECTED_RECORD_EXPRESSION nvarchar(255) = 'CONCAT(Description, ''; '', Kiosk_Type)'
