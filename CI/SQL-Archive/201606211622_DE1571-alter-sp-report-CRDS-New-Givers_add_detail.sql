...
/****** Object:  StoredProcedure [dbo].[report_CRDS_New_Givers]    Script Date: 6/21/2016 8:20:56 AM ******/
SET ANSI_NULLS ON
GO
...
f.sddonid as 'Soft Credit Donor ID',f.sddisplayname as 'Soft Credit Display Name',f.sdaddr1 as 'Soft Credit Address1',f.sdaddr2 as 'Soft Credit Address2',f.sdcity as 'Soft Credit City',f.sdzip as 'Soft Credit Zip' from #ftdonordetail f 
