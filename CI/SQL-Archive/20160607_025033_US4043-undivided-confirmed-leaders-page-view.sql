...
DECLARE @VIEW_TITLE nvarchar(255) = N'Confirmed Facilitators'
DECLARE @PAGE_ID int = 556
DECLARE @DESCRIPTION nvarchar(255) = N'Staff members can view the users that have been confirmed to a group as a leader.'
...
SELECT @VIEW_ID = [Page_View_ID] FROM [dbo].[dp_Page_Views] WHERE [Page_View_ID] = 2303;
