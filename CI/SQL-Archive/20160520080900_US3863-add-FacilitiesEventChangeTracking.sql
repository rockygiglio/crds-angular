...
IF NOT EXISTS(SELECT * FROM [dbo].[dp_reports] WHERE Report_Path = '/MPReports/CRDS Facilities Event Change Tracking')
BEGIN
	INSERT INTO [dbo].[dp_reports]
		 ...
		 VALUES
			   (N'Facilities Event Change Tracking'
			   ,N'Facilities Event Change Tracking'
			   ,N'/MPReports/CRDS Facilities Event Change Tracking'
			   ,1
			   ,0          
			   ,1)
END
...
SELECT @report_id = r.Report_ID FROM
	[dp_reports] r WHERE r.Report_Path = N'/MPReports/CRDS Facilities Event Change Tracking'
