...
Primary_Contact_Table.[Display_Name] AS [Primary_Contact_Name],
Primary_Contact_Table_User_Account_Table_Contact_ID_Table.[Email_Address] AS [Primary_Contact_Email],
Groups.Description,
Groups.Start_Date,
Groups.End_Date,
