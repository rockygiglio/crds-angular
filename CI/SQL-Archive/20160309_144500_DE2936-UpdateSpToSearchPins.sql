...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[api_crds_get_Pins_Within_Range]') AND type in (N'P', N'PC'))
BEGIN
	DROP PROCEDURE dbo.api_crds_get_Pins_Within_Range
END
