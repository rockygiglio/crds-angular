...
DECLARE @Attribute_ID_Base AS INT = 7086
...
SELECT
	@Attribute_Type_ID = 87,
	@Attribute_Type_Name = 'Undivided Co-facilitator',
	@Attribute_Type_Description = 'Answer for ''OPTIONAL: Do you know who you would like to be your co-facilitator (of different race)?''',
...
INSERT INTO @Attribute_Names
	...
	VALUES
	(@Attribute_ID_Base, 'co-facilitator', null, 1)
