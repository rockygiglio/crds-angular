...
, Participant_ID_Table.[Approved_Small_Group_Leader] AS [Approved_Small_Group_Leader]
, Group_Role_ID_Table.[Group_Role_ID] AS [Group_Role_ID] 
, Group_Role_ID_Table.[Role_Title] AS [Role_Title] 
, Participant_ID_Table.[Participant_ID] AS [Participant_ID],Participant_ID_Table_Contact_ID_Table.[Email_Address] AS [Email]'
WHERE Sub_Page_View_ID = 204;
