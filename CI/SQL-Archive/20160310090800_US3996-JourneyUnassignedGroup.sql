...
VALUES(2217,'Current Journey Unassigned Group',316,'BRAVE Journey participants that are non-local and were not able to join a group ','Participant_ID_Table_Contact_ID_Table.[First_Name]
...
,STUFF((SELECT '', '' + Attribute_Name 
 ...
 ','Group_ID_Table.Group_ID = 166573 AND  (Group_Participants.End_Date > GetDate() OR Group_Participants.End_Date IS NULL)
',NULL,NULL,NULL)
