...
DECLARE @PAGE_ID int = 618 -- Assigned by MPIdentityMaintenance.dbo.Get_Next_Available_ID
DECLARE @PAGE_SECTION_ID int = 3 -- "Facilities" page
DECLARE @DISPLAY_NAME nvarchar(50) = N'Bumping Rules'
DECLARE @SINGULAR_NAME nvarchar(50) = N'Bumping Rule'
DECLARE @DESCRIPTION nvarchar(255) = N'Page for Bumping Rules.'
DECLARE @VIEW_ORDER smallint = 43
DECLARE @TABLE_NAME nvarchar(50) = 'cr_Bumping_Rules'
DECLARE @PRIMARY_KEY nvarchar(50) = 'Bumping_Rules_ID'
DECLARE @DEFAULT_FIELD_LIST nvarchar(2000) = 'Bumping_Rules_ID'
DECLARE @SELECTED_RECORD_EXPRESSION nvarchar(255) = 'Bumping_Rules_ID'
