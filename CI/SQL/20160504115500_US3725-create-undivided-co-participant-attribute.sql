...
DECLARE @Attribute_ID_Base AS INT = 7087
...
SELECT
	@Attribute_Type_ID = 88,
	@Attribute_Type_Name = 'Undivided Co-participant',
	@Attribute_Type_Description = 'Answer for ''OPTIONAL: Do you know who you would like to be your co-participant (of different race)?''',
...
INSERT INTO @Attribute_Names
	...
	VALUES
	(@Attribute_ID_Base, 'co-participant', null, 1)
