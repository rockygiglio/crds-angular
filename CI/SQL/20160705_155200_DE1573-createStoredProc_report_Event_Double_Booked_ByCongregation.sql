...
/****** Object:  StoredProcedure [dbo].[report_Event_Double_Booked_ByCongregation]    Script Date: 7/5/2016 3:41:21 PM ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[report_Event_Double_Booked_ByCongregation]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'

CREATE PROCEDURE [dbo].[report_Event_Double_Booked_ByCongregation]
