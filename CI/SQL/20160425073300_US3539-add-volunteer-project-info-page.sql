...
INSERT INTO [dbo].[dp_Pages]
     ...
     VALUES
           ...
           ,'Registration_ID_Table_Participant_ID_Table_Contact_ID_Table.[First_Name] AS [Volunteer First Name]
				...
				, Group_Connector_ID_Table_Primary_Registration_Table_Participant_ID_Table_Contact_ID_Table.[Display_Name] AS [TC Name]
				, Group_Connector_ID_Table_Primary_Registration_Table_Participant_ID_Table_Contact_ID_Table.[Email_Address] AS [TC Email]
				, Group_Connector_ID_Table_Primary_Registration_Table_Participant_ID_Table_Contact_ID_Table.[Mobile_Phone] AS [TC Phone]
