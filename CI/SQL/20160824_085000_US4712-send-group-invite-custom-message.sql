...
DECLARE @Body VARCHAR(max) = '<div>' +
								 ...
								 '</div>' +
								 '<div style="font-family: Verdana; font-size: 12px;">' +
								 	'[Leader_Name] has invited you to join [Group_Name]. To accept their invitation, click the link below. You will be asked to sign into your Crossroads.net account and preview the group before joining. ' +
								 '</div>' +
							 	 '<div style="font-family: Verdana; font-size: 12px;">' +
								 	'<br />' +
								 '</div>' +
