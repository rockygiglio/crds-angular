...
/****** Object:  StoredProcedure [dbo].[report_CRDS_Childcare_Summary]    Script Date: 1/12/2017 11:22:05 AM ******/
SET ANSI_NULLS ON
GO
...
AS
    BEGIN
		...
		WHILE @@FETCH_STATUS = 0 BEGIN
		   ...
		   AND ( g.End_Date > GETDATE() OR g.End_Date is null ) 
		   AND ( gp.End_Date > GETDATE() OR gp.End_Date IS NULL ) 
		   AND ( gp.Start_Date < GETDATE() )
		   AND ( g.Start_Date < GETDATE() )
