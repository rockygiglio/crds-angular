...
/****** Object:  StoredProcedure [dbo].[api_crds_Create_Medical_Info_For_Contacts]    Script Date: 11/7/2016 11:19:54 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	ELSE
	BEGIN
		UPDATE cr_Medical_Information SET InsuranceCompany = @InsuranceCompany, PolicyHolderName = @PolicyHolder, PhysicianName = @PhysicianName, PhysicianPhone = @PhysicianPhone, Contact_ID = @ContactId
