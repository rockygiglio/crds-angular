...
DECLARE @PAGE_ID int = 614 -- Assigned by MPIdentityMaintenance.dbo.Get_Next_Available_ID
DECLARE @PAGE_SECTION_ID int = 10 -- "Administration" page
DECLARE @DISPLAY_NAME nvarchar(50) = N'Kiosk Configs'
DECLARE @SINGULAR_NAME nvarchar(50) = N'Kiosk Config'
DECLARE @DESCRIPTION nvarchar(255) = N'Configs used for kiosk setup.'
DECLARE @VIEW_ORDER smallint = 130
DECLARE @TABLE_NAME nvarchar(50) = 'cr_Kiosk_Configs'
DECLARE @PRIMARY_KEY nvarchar(50) = 'Kiosk_Config_ID'
DECLARE @DEFAULT_FIELD_LIST nvarchar(2000) = 'Kiosk_Config_ID,
_Kiosk_Identifier,
Kiosk_Name,
Kiosk_Description,
Kiosk_Type_ID,
...
Start_Date,
End_Date'
DECLARE @SELECTED_RECORD_EXPRESSION nvarchar(255) = 'Kiosk_Name'
