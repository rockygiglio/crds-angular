...
DECLARE @VIEW_TITLE nvarchar(255) = N'Undivided - Assigned Participants'
...
DECLARE @FIELD_LIST nvarchar(2000) = N'Group_Participants.[Start_Date] AS [Registration Date] 
	...
	,(SELECT Notes FROM Group_Participant_Attributes GPA, Attributes A 
...
SELECT @VIEW_ID = [Page_View_ID] FROM [dbo].[dp_Page_Views] WHERE [Page_View_ID] = 92142;
