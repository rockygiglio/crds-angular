...
DECLARE @PAGE_ID int = 615 -- Assigned by MPIdentityMaintenance.dbo.Get_Next_Available_ID
DECLARE @PAGE_SECTION_ID int = 10 -- "Administration" page
DECLARE @DISPLAY_NAME nvarchar(50) = N'Group Attributes'
DECLARE @SINGULAR_NAME nvarchar(50) = N'Group Attribute'
DECLARE @DESCRIPTION nvarchar(255) = N'Group Attributes, used by API'
DECLARE @VIEW_ORDER smallint = 99
DECLARE @TABLE_NAME nvarchar(50) = 'Group_Attributes'
DECLARE @PRIMARY_KEY nvarchar(50) = 'Group_Attribute_ID'
DECLARE @DEFAULT_FIELD_LIST nvarchar(2000) = 'Group_ID_Table.Group_Name,
...
DECLARE @SELECTED_RECORD_EXPRESSION nvarchar(255) = 'Attribute_ID_Table.Attribute_Name'
DECLARE @DISPLAY_COPY bit = 1
