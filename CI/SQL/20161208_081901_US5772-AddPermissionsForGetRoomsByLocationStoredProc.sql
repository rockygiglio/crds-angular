...
IF NOT EXISTS(SELECT * FROM [dbo].[dp_API_Procedures] WHERE [procedure_name] = 'api_crds_GetReservedAndAvailableRoomsByLocation')
BEGIN
	DECLARE @ID INT

	INSERT INTO [dbo].[dp_API_Procedures] ([procedure_name]) 
	VALUES('api_crds_GetReservedAndAvailableRoomsByLocation')
