...
IF NOT EXISTS(SELECT * FROM [dbo].[dp_reports] WHERE Report_Path = '/MPReports/Crossroads/CRDS Large Donations')
BEGIN
	INSERT INTO [dbo].[dp_reports]
		 ...
		 VALUES
			   (N'Large Donations'
			   ,N'Large Donations'
			   ,N'/MPReports/Crossroads/CRDS Large Donations'
			   ,0
			   ,0          
			   ,1)
END
...
SELECT @report_id = r.Report_ID FROM
	[dp_reports] r WHERE r.Report_Path = N'/MPReports/Crossroads/CRDS Large Donations'
