...
DECLARE @PAGE_ID int = 619 -- Assigned by MPIdentityMaintenance.dbo.Get_Next_Available_ID
DECLARE @PAGE_SECTION_ID int = 3 -- "Facilities" page section
DECLARE @DISPLAY_NAME nvarchar(50) = N'Printer Maps'
DECLARE @SINGULAR_NAME nvarchar(50) = N'Printer Map'
DECLARE @DESCRIPTION nvarchar(255) = N'Mapping Table for Printers and Computers'
DECLARE @VIEW_ORDER smallint = 87
DECLARE @TABLE_NAME nvarchar(50) = 'cr_Printer_Maps'
DECLARE @PRIMARY_KEY nvarchar(50) = 'Printer_Map_ID'
DECLARE @DEFAULT_FIELD_LIST nvarchar(2000) = 'Printer_Map_ID,
Printer_Name,
Computer_Name'
DECLARE @SELECTED_RECORD_EXPRESSION nvarchar(255) = 'CONCAT(Printer_Map_ID, ''; '', Printer_Name, ''; '', Computer_Name)'
...
-- Add this to the "Facilities" Page
