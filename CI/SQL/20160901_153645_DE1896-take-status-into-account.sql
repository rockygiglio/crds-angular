...
/****** Object:  StoredProcedure [dbo].[api_crds_Add_As_TripParticipant]    Script Date: 9/1/2016 3:33:58 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT @Number_Of_Pledges = COUNT(*) FROM dbo.Pledges p WHERE p.Pledge_Campaign_ID = @PledgeCampaignID AND p.Pledge_Status_ID = 1
