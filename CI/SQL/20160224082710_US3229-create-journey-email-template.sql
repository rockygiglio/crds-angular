...
INSERT INTO @Email_Templates
	...
	(17462
		 ...
		 , '<div><span style="font-family: Arial; font-size: 13px;"><b>Are you ready for a six-week spiritual journey? </b></span><br /></div><div><br /></div><div><span style="font-family: Arial; font-size: 13px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">BRAVE is about taking a new step and walk in confidence of who God made us to be. Through weekend teaching, individual work and meeting with a small group, we’ll be challenged to lean into God and to do new things. Step one is to join a group. </span><br /></div><div><br /></div><div><span style="font-family: Arial; font-size: 13px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">Here’s the link to the group. </span><br /></div><div><span style="font-family: Arial; font-size: 13px;"><a href="https://[BaseUrl]/brave/group/join/[GroupId]">Click here to join</a></span></div><div></div><div><div><br /></div></div>'
