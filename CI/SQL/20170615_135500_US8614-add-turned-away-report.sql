...
IF NOT EXISTS(SELECT * FROM [dbo].[dp_reports] WHERE Report_Path = '/MPReports/Crossroads/CRDS Checkin Turned Away')
BEGIN
	...
	INSERT INTO [dbo].[dp_reports]
		 ...
		 VALUES
			   (322
			   ,N'CRDS Checkin Turned Away'
			   ,N'CRDS Checkin Turned Away'
			   ,N'/MPReports/Crossroads/CRDS Checkin Turned Away'
			   ,0
			   ,0          
			   ,1)
...
SELECT @report_id = r.Report_ID FROM
	[dp_reports] r WHERE r.Report_Path = N'/MPReports/Crossroads/CRDS Checkin Turned Away'
