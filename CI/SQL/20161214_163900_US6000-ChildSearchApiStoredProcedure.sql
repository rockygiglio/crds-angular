...
-- Description:	Get the kids who are eligible to checkin for a given phone number.
--              The phone number format should be nnn-nnn-nnnn, but this searches Contacts and
--              Households for the number with and without the dashes.  This returns two result
--              sets - one with a single row indicating the primary household ID matching
--              the phone number, the other with the list of matching kids.
-- =============================================
