...
INSERT INTO [dbo].[dp_Communications]
     ...
     VALUES
           (
			...
			'<span style="font-family: ''Helvetica Neue'', Helvetica, Arial, sans-serif; font-size: 13px; background-color: rgb(255, 255, 255);">Your request for Childcare for [Group] at [Congregation] on [ChildcareSession], [Frequency] has been denied for the following dates [Dates].<br />Decision Notes: [DecisionNotes]<br />Please click on the link below to review.</span><div><a href="https://[Base_Url]/ministryplatform#/36/[RequestId]" target="_self">Rejected-Childcare-Request</a><font face="Helvetica Neue, Helvetica, Arial, sans-serif"><br /></font><div><br /></div></div>',
			1,
			Getdate(),
			1,
			7542465,
