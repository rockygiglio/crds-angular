...
--Add a donation from last year for Wilma
...
(@wilmaDonorId  ,250.0000       ,CAST(@lastYear+'-09-03 00:01' as smalldatetime),2              ,null                  ,null       ,null    ,null ,null            ,0          ,null               ,null                       ,2                 ,CAST(@lastYear+'-09-03 00:01' as smalldatetime),null                 ,null                       ,null            ,null             ,null            ,1        ,1        ,null    ,1        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,null            ,null        ,null                ,null                   ,null                     );
...
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc),250.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO
...
INSERT INTO [dbo].Donations 
(Donor_ID      ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date                              ,Donation_Status_Notes,Online_Donation_Information,Transaction_Code              ,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId  ,150.0000       ,CAST(@thisYear+'-01-03 06:00:00' as smalldatetime),4              ,null                  ,null       ,null    ,null ,null            ,0          ,null               ,null                       ,2                 ,CAST(@thisYear+'-01-03 06:00:00' as smalldatetime),null                 ,null                       ,'ch_16odS5Eldv5NE53si5NDZzoN' ,null             ,null            ,1        ,1        ,null    ,1        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,null            ,null        ,null                ,null                   ,null                     );

--Insert the Donation_Distribution. 
INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                        ,Amount  ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc),150.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO

--Add a Donation by Wilma, with bank ACH but no stripe information. This mirrors bank transactions migrated from legacy.
DECLARE @wilmaDonorId as int
set @wilmaDonorId = (select donor_record from Contacts where Email_Address = 'mpcrds+auto+wilmaflintstone@gmail.com');
...
INSERT INTO [dbo].Donations 
(Donor_ID      ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date      ,Donation_Status_Notes,Online_Donation_Information,Transaction_Code,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId  ,200.0000       ,CAST(@thisYear+'-01-03 08:00:00' as smalldatetime),5              ,null                  ,null       ,null    ,null ,null            ,0          ,null               ,null                       ,2                 ,{ts '2015-09-01 00:00:00'},null                 ,null                       ,null            ,null             ,null            ,1        ,1        ,null    ,1        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,null            ,null        ,null                ,null                   ,null                     );

--Insert the Donation_Distribution. This has a lot of sub-selects to get the right data. Sorry :(
INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                        ,Amount  ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc),200.0000,54        ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO
...
--Add a Donation by Wilma, with credit card that we will do a partial refund on
DECLARE @wilmaDonorId as int
set @wilmaDonorId = (select donor_record from Contacts where Email_Address = 'mpcrds+auto+wilmaflintstone@gmail.com');
...
INSERT INTO [dbo].Donations 
(Donor_ID      ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date                              ,Donation_Status_Notes,Online_Donation_Information,Transaction_Code             ,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId  ,555.0000       ,CAST(@thisYear+'-01-04 00:00:00' as smalldatetime),4              ,null                  ,null       ,null    ,null ,null            ,0          ,null               ,null                       ,2                 ,CAST(@thisYear+'-01-04 00:00:00' as smalldatetime),null                 ,null                       ,'ch_16ngVCEldv5NE53s9ZK1bq1Z',null             ,null            ,1        ,1        ,null    ,1        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,null            ,null        ,null                ,null                   ,null                     );

--Insert the Donation_Distribution. This has a lot of sub-selects to get the right data. Sorry :(
INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                        ,Amount  ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc),555.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO

--Add a Donation refund by Wilma, with credit card
DECLARE @wilmaDonorId as int
set @wilmaDonorId = (select donor_record from Contacts where Email_Address = 'mpcrds+auto+wilmaflintstone@gmail.com');
...
INSERT INTO [dbo].Donations 
(Donor_ID      ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes                     ,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date                              ,Donation_Status_Notes,Online_Donation_Information,Transaction_Code             ,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId  ,-55.0000       ,CAST(@thisYear+'-01-04 05:00:00' as smalldatetime),4              ,null                  ,null       ,null    ,'Refund on last donation' ,null            ,0          ,null               ,null                       ,2                 ,CAST(@thisYear+'-01-04 05:00:00' as smalldatetime),null                 ,null                       ,'re_16ngWoEldv5NE53sFQdhoGr8',null             ,null            ,1        ,1        ,null    ,1        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,null            ,null        ,null                ,null                   ,null                     );

--Insert the Donation_Distribution. This has a lot of sub-selects to get the right data. Sorry :(
INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                        ,Amount  ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc),-55.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO

--Add a declined donation for Wilma Flintstone
DECLARE @wilmaDonorId as int
set @wilmaDonorId = (select donor_record from Contacts where Email_Address = 'mpcrds+auto+wilmaflintstone@gmail.com');
...
INSERT INTO [dbo].donations 
(Donor_ID     ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date                              ,Donation_Status_Notes                                                          ,Online_Donation_Information,Transaction_Code             ,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId ,300.0000       ,CAST(@thisYear+'-01-05 11:27:27' as smalldatetime),5              ,null                  ,null       ,null    ,null ,null            ,null       ,null               ,null                       ,3                 ,CAST(@thisYear+'-01-05 11:27:27' as smalldatetime),'insufficient_funds: Your account has insufficient funds to cover the payment.',null                       ,'py_16obd5Eldv5NE53s36krdjBt',null             ,null            ,null     ,1        ,null    ,0        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,1               ,null        ,0.2500              ,null                   ,null                     );

INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                         ,Amount  ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc) ,300.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO

--Add a pending donation for Wilma Flintstone
DECLARE @wilmaDonorId as int
set @wilmaDonorId = (select donor_record from Contacts where Email_Address = 'mpcrds+auto+wilmaflintstone@gmail.com');
...
INSERT INTO [dbo].donations 
(Donor_ID     ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date                              ,Donation_Status_Notes,Online_Donation_Information,Transaction_Code             ,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId ,180.0000       ,CAST(@thisYear+'-01-05 12:27:27' as smalldatetime),5              ,null                  ,null       ,null    ,null ,null            ,null       ,null               ,null                       ,1                 ,CAST(@thisYear+'-01-05 12:27:27' as smalldatetime),null                 ,null                       ,'py_16obd5Eldv5NE53s36krdjBt',null             ,null            ,null     ,1        ,null    ,0        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,1               ,null        ,0.2500              ,null                   ,null                     );

INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                         ,Amount  ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc) ,180.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO
...
INSERT INTO [dbo].donations 
(Donor_ID     ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date                              ,Donation_Status_Notes,Online_Donation_Information,Transaction_Code             ,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID        ,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId ,42.0000        ,CAST(@thisYear+'-01-07 12:27:27' as smalldatetime),1              ,null                  ,'1234'     ,null    ,null ,null            ,null       ,null               ,null                       ,2                 ,CAST(@thisYear+'-01-06 12:27:27' as smalldatetime),null                 ,null                       ,'py_17q50XEldv5NE53sDWzSG9s6',null             ,null            ,null     ,1        ,null    ,0        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,1               ,'cus_85UsQReBytr2dn',0.25                ,null                   ,null                     );

INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                         ,Amount ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc) ,42.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO
...
INSERT INTO [dbo].donations 
(Donor_ID     ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date                              ,Donation_Status_Notes,Online_Donation_Information,Transaction_Code,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID        ,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId ,43.0000        ,CAST(@thisYear+'-01-07 13:27:27' as smalldatetime),1              ,null                  ,'1337'     ,null    ,null ,null            ,null       ,null               ,null                       ,2                 ,CAST(@thisYear+'-01-06 12:27:27' as smalldatetime),null                 ,null                       ,null            ,null             ,null            ,null     ,1        ,null    ,0        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,1               ,null                ,0.25                ,null                   ,null                     );

INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                         ,Amount ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc) ,43.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO
...
INSERT INTO [dbo].donations 
(Donor_ID     ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date                              ,Donation_Status_Notes,Online_Donation_Information,Transaction_Code             ,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID        ,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId ,44.0000        ,CAST(@thisYear+'-01-07 14:27:27' as smalldatetime),1              ,null                  ,null       ,null    ,null ,null            ,null       ,null               ,null                       ,2                 ,CAST(@thisYear+'-01-06 12:27:27' as smalldatetime),null                 ,null                       ,'py_17q5pZEldv5NE53s2tTutxOz',null             ,null            ,null     ,1        ,null    ,0        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,1               ,'cus_85UsQReBytr2dn',0.25                ,null                   ,null                     );

INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                         ,Amount ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc) ,44.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO
...
INSERT INTO [dbo].donations 
(Donor_ID     ,Donation_Amount,Donation_Date                                     ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date                              ,Donation_Status_Notes,Online_Donation_Information,Transaction_Code,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId ,45.0000        ,CAST(@thisYear+'-01-07 15:27:27' as smalldatetime),1              ,null                  ,null       ,null    ,null ,null            ,null       ,null               ,null                       ,2                 ,CAST(@thisYear+'-01-06 12:27:27' as smalldatetime),null                 ,null                       ,null            ,null             ,null            ,null     ,1        ,null    ,0        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,1               ,null        ,null                ,null                   ,null                     );

INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                         ,Amount ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc) ,45.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO
...
INSERT INTO [dbo].donations 
(Donor_ID     ,Donation_Amount,Donation_Date ,Payment_Type_ID,Non_Cash_Asset_Type_ID,Item_Number,Batch_ID,Notes,Donor_Account_ID,[Anonymous],Check_Scanner_Batch,Donation_Status_Information,Donation_Status_ID,Donation_Status_Date,Donation_Status_Notes,Online_Donation_Information,Transaction_Code,Subscription_Code,Gateway_Response,Processed,Domain_ID,Currency,Receipted,Invoice_Number,Receipt_Number,__ExternalContributionID,__ExternalPaymentID,__ExternalGiverID,__ExternalDonorID,__ExteralMasterID1,__ExternalMasterID2,Registered_Donor,Processor_ID,Processor_Fee_Amount,Reconcile_Change_Needed,Reconcile_Change_Complete) VALUES
(@wilmaDonorId ,72.0000        ,getDate()     ,4              ,null                  ,null       ,null    ,null ,null            ,null       ,null               ,null                       ,4                 ,getDate()           ,null                 ,null                       ,null            ,null             ,null            ,null     ,1        ,null    ,0        ,null          ,null          ,null                    ,null               ,null             ,null             ,null              ,null               ,1               ,null        ,null                ,null                   ,null                     );

INSERT INTO [dbo].donation_distributions 
(Donation_ID                                                                                         ,Amount ,Program_ID,Pledge_ID,Target_Event,Soft_Credit_Donor,Notes,Domain_ID,__ExternalContributionID,__ExternalCommitmentID,Congregation_ID) VALUES
((select top 1 Donation_ID from donations where donor_id = @wilmaDonorId order by Donation_date desc) ,72.0000,3         ,null     ,null        ,null             ,null ,1        ,null                    ,null                  ,5              );
GO