...
('(t) Test Pledge Program2',12             ,8          ,DATEADD(YEAR, -1,GETDATE()),DATEADD(YEAR, 1,GETDATE())     ,1              ,null           ,2562428        ,null       ,null              ,null                   ,1                       ,'(t) Test Pledge Program2',1                  ,1                  ,2                ,null              ,null          ,null                ,1                     ,1        ,1               ,null            ,null            , 1 );
