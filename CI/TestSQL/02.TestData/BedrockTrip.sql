...
(10000010          ,@tripName    ,@tripName       ,2                      ,'Church Mobilization - Bedrock',5000.00      ,CAST(@startYear as smalldatetime),CAST(@tripStart as smalldatetime),1        ,null    ,null      ,null          ,null                ,CAST(@startYear as smalldatetime),CAST(@tripStart as smalldatetime),null               ,17                  ,100.0000            ,1000.0000       ,@formID           ,null                 ,0                  ,null                    ,0                     ,0                 ,40              ,99              );
