...
DELETE FROM OPPORTUNITIES WHERE ADD_TO_GROUP IN (SELECT GROUP_ID FROM GROUPS WHERE GROUP_NAME = '(t) FI Oakley Coffee Team');

DELETE FROM GROUP_PARTICIPANTS WHERE GROUP_ID IN (SELECT GROUP_ID FROM GROUPS WHERE GROUP_NAME = '(t) FI Oakley Coffee Team');

DELETE FROM EVENT_PARTICIPANTS WHERE GROUP_ID IN (SELECT GROUP_ID FROM GROUPS WHERE GROUP_NAME = '(t) FI Oakley Coffee Team');
