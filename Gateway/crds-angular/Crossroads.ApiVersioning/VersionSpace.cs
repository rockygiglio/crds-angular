...
namespace Crossroads.ApiVersioning
{
    ...
    {
        private static SortedList<string, VersionSpace> routes;
        ...
        {
            routes = new SortedList<string, VersionSpace>();
        }
        ...
        public JObject Report(dynamic report, bool includeMissingDefaults=false)
        {
            string state = null;
            ...
            if (!hasDefault && includeMissingDefaults)
                report.Default = "none";
