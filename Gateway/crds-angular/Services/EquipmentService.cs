...
namespace crds_angular.Services
{
    ...
    {
        private readonly MinistryPlatform.Translation.Services.Interfaces.IEquipmentRepository _mpEquipmentService;

        public EquipmentService(MinistryPlatform.Translation.Services.Interfaces.IEquipmentRepository equipmentService)
        {
