...
namespace crds_angular.test.Services
{
    public class EzScanCheckScannerServiceTest
    {
        ...
        public void TestCreateDonationsFromBatch()
        {
            ...
            _paymentService.Setup(mocked => mocked.ChargeCustomer(contactDonorExisting.Account.ProcessorId, contactDonorExisting.Account.ProcessorAccountId, checks[0].Amount, contactDonorExisting.DonorId, checks[0].CheckNumber, contactDetails.EmailAddress, contactDetails.DisplayName)).Returns(new StripeCharge
            {
                Id = "1020304",
            ...
            _paymentService.Setup(
                mocked =>
                    mocked.ChargeCustomer(stripeCustomer.id,
                                          ...
                                          checks[0].CheckNumber, contactDetails.EmailAddress, contactDetails.DisplayName)).Returns(mockChargeNonExistingStripeCustomer);
